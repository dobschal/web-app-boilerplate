...
export function Form(...params) {
  ...
  export function AsyncList(childrenBuilder) {
    const el = List();
    el.reload = function () {
  ...
  export function PasswordInput(label, name) {
   ...
   */
  export function build({ tag = "div", text, children = [], ...attributes }) {
